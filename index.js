...
console.log('The messageUpdate event will not log if `channel.name == 📊system-monitor`');
Log('append', 'DiscordBot', 'The messageUpdate event will not log if `channel.name == 📊system-monitor`', 'DEBUG');
