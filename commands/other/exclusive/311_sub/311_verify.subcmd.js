...
module.exports = async function (client, interaction) {
    ...
    await interaction.reply({embeds: [prompt], components: [selectMenu, buttonRow], fetchReply: true})
        .then(async (msg) => {
            ...
            client.on("interactionCreate", async (newInteraction) => {
                if(!newInteraction.isModalSubmit() || collectedModal === true) {
                    return;
                }
                collectedModal = true;

                if(newInteraction.customId === "prompt_name") {
